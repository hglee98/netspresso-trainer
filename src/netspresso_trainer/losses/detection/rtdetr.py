...
https://github.com/lyuwenyu/RT-DETR/blob/main/rtdetr_pytorch/src/zoo/rtdetr/rtdetr_criterion.py
...
class HungarianMatcher(nn.Module):
    def __init__(self, weight_dict, alpha, gamma, use_focal_loss=False, **kwargs):
